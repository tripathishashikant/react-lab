...
2. **Standard Headers**: Instead of "Wizard Mode", use professional headers like `### [Phase: Planning]` or `### [Status: Testing]`.
...
6. **Automatic Documentation**: Use the `wizard-context-updater` (Internal name) to keep `.ai/` documentation in sync with the codebase after every task.

## Process Reference
- **Lifecycle Phases**: `.ai/wizard/PHASES.md`
- **Quality Checklists**: `.ai/wizard/CHECKLISTS.md`
- **Pattern Library**: `.ai/wizard/PATTERNS.md`
